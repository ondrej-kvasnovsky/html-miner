...
public class CustomClassMinerTest {
   ...
   public final void testCustomClassMiner() throws CustomClassProcessingException {
      ...
      // create new entry, entry is exact mapping to the field in the custom class
      // search criteria says where to get and data and how to find them (regex)
   ...
   /**
    * Test method for {@link htmlminer.core.customclass.CustomClassMiner#getObject(java.net.URL, java.lang.String)}.
    * 
    * @throws CustomClassProcessingException
    */
   @Test
